...
void TestCliqueContraction() {
    ...
    {
        ASSERT_EQUAL(contracted.GetCellId(1), 6);
        ASSERT_EQUAL(contracted.GetCellId(1, 1), 6);
        ASSERT_EQUAL(contracted.GetCellId(5), 6);
        ASSERT_EQUAL(contracted.GetCellId(5, 1), 6);
        ASSERT_EQUAL(contracted.GetCellId(6, 1), 6);
        ASSERT_EQUAL(contracted.GetCellId(6, 2), 9);
        ASSERT_EQUAL(contracted.GetCellId(0, 2), 9);
        ASSERT_EQUAL(contracted.GetCellId(0, 3), 11);
        ASSERT_EQUAL(contracted.GetCellId(6, 3), 11);

        ASSERT_EQUAL(contracted.GetCellId(6), 9);
        ASSERT_EQUAL(contracted.GetCellId(7), 10);
        ASSERT_EQUAL(contracted.GetCellId(8), 10);
        ASSERT_EQUAL(contracted.GetCellId(6, 1), 6);
        ASSERT_EQUAL(contracted.GetCellId(7, 1), 7);
        ASSERT_EQUAL(contracted.GetCellId(8, 1), 8);

//        ASSERT_EQUAL(contracted.GetCells(0), ToVector(std::views::iota(0u, 6u)));
//        ASSERT_EQUAL(contracted.GetCells(1), ToVector(std::views::iota(6u, 9u)));
//        ASSERT_EQUAL(contracted.GetCells(2), ToVector(std::views::iota(9u, 11u)));
//        ASSERT_EQUAL(contracted.GetCells(3), ToVector(std::views::iota(11u, 12u)));
...
//        ASSERT_EQUAL(contracted.GetVertices(11), std::vector<VertexId>({9, 10}));
        ...
        ASSERT_EQUAL(contracted.VerticesCount(), 11);
